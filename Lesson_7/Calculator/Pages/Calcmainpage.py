...
class CalcMain:
    ...
    # кликаем на элементы калькулятора
    def clickin_buttons(self):
    ...
    # ожидаем появление элемента и выводим значение в текст
    def wait_button_gettext(self):
        # wait for the calculation to complete
        WebDriverWait(self.browser, 46).until(EC.text_to_be_present_in_element((By.CLASS_NAME, "screen"))).click()
